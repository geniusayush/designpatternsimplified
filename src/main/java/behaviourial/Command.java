...
class Client {
    ...
    public static void main(String[] args) {
        ...
        TurnOff turnOff = new TurnOff(bulb); // we have alreadyt linked recveiver and commmand and we are free frok our end
        // the invoker will noe do it from his or her own end
        // Invoker
    ...
    /* Command pattern can also be used to implement a transaction based system.
     ...
     If the final command is successfully executed, all good otherwise just iterate through the history and
